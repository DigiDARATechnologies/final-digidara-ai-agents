...
16. Once the score and the viva are both passed, the learner can download a final report PDF (score, requirements, viva results and feedback, with the DigiDARA Technologies logo on every page).
