"""Self-register the certificate_agent service with the DigiDARA orchestrator."""
...
logger = logging.getLogger("certificate.integration.registry")
...
class RegistryClient:
    ...
    async def _register(self) -> bool:
        try:
            ...
            logger.warning("registry unavailable at %s; registration will retry", ORCHESTRATOR_URL, exc_info=True)
            return False
