"""Gateway signature verification (aptitude_agent). Kept in step with orchestrator/tests/test_agent_signing.py."""
from flask import Flask, jsonify, request

from backend.app.integration import agent_signing as signing
