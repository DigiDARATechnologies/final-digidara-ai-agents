...
from app.auth.schemas import GoogleAuthRequest, LoginRequest, SignupRequest, TokenResponse, UserOut
...
def _to_out(user: User) -> UserOut:
    return UserOut(id=user.id, name=user.name, email=user.email, mobile=user.mobile)
